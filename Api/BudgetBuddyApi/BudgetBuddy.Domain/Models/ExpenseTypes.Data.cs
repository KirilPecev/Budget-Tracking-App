        ...
        public IEnumerable<object> GetData()
           => new List<ExpenseTypes>
           {
                new ExpenseTypes(
                    ...
                    25, null, AmountTypePercent),
                new ExpenseTypes("Transportation",
                    ...
                    10, null, AmountTypePercent),
                new ExpenseTypes("Food",
                ...
                new ExpenseTypes("Utilities",
                    ...
                    5, null, AmountTypePercent),
                new ExpenseTypes("Insurance",
                    ...
                    10, null, AmountTypePercent),
                new ExpenseTypes("Medical & Healthcare",
                    "Dedicated to managing expenses related to your health and well-being. This category encompasses a range of healthcare-related costs, ensuring that you can prioritize your physical and mental well-being without financial stress.",
                    5, null, AmountTypePercent),
                new ExpenseTypes("Saving," +
                    " Investing, & Debt Payments", "Designed to empower you in achieving your financial goals, building a secure future, and managing debt responsibly. This comprehensive category covers a spectrum of financial activities aimed at both saving for the future and strategically managing existing debts.",
                    20, null, AmountTypePercent),
                new ExpenseTypes("Personal Spending",
                    "This category is a catch-all for anything that could be considered a personal care or “lifestyle” expense.",
                    5, null, AmountTypePercent),
                new ExpenseTypes("Recreation & Entertainment",
                    ...
                    5, null, AmountTypePercent),
                new ExpenseTypes("Miscellaneous",
                    "This budget category is reserved for anything that isn’t already covered in your basic budget categories. It can also be used as an “overflow” category when you need a little extra somewhere else.",
                    5, null, AmountTypePercent),
           };
    }
}
